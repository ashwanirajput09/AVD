...
New-AzWvdHostPool -ResourceGroupName $Resourcegroup -Name 'AVDHOSTPOOL' -WorkspaceName 'AVDWORKSPACE' -HostPoolType 'Pooled' -LoadBalancerType 'BreadthFirst' -Location $Location -DesktopAppGroupName 'AVDAPPGROUP' -PreferredAppGroupType 'Desktop'